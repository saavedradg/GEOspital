...
const HealthMap = forwardRef<HealthMapRef, HealthMapProps>(
  ({ facilities, selectedFacilityId, onMarkerPress, onMapPress }, ref) => {
    ...
    useEffect(() => {
      ...
      }).setView([config.santiago.latitude, config.santiago.longitude], 12);
    ...
    useEffect(() => {
      ...
      facilities.forEach((facility) => {
        ...
        const icon = L.divIcon({
          className: '',
          html: `<div style="width:${size}px;height:${size}px;border-radius:50%;background:${color};border:2.5px solid #fff;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,0.3);transition:all 0.2s;"><svg width="14" height="14" viewBox="0 0 24 24" fill="white"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 11h-4v4h-4v-4H6v-4h4V6h4v4h4v4z"/></svg></div>`,
          iconSize: [size, size],
